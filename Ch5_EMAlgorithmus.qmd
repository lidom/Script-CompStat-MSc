...
X_1,\dots,X_n\overset{\text{i.i.d}}{\sim}X,
$$
where $X\text{Bernoulli}(p).$ Write the expression of the likelihood function. 

(b) Now let
$$
X_1,\dots,X_n\overset{\text{i.i.d}}{\sim}X,
$$
where $X$ is a Bernoulli mixture random variable with parameters $p_g$ and prior probabilities $\pi_g$, $g=1,\dots,G$. Write the expression of the likelihood function.  
