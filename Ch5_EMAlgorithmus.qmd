...
## Bayes Classifier: Clustering using Gaussian Mixture Distributions
...
**Bayes Classifier**<br>
The Bayes classifier assigns each observation $i$ to the group with the largest posterior probability $p_{ig}$
$$
