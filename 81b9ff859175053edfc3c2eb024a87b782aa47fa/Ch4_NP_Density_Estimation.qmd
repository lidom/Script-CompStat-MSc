...
**Most common goal:** Automatic data-dependent bandwidth selection that is **"globally optimal"** ; i.e. optimal for relevant all $x$ in $f(x).$
...
* True density function $f:$
   * $f$ consistent and sufficiently often differentiable in $x$
* Kernel function $K$: 
    * consistent and $K(z)\geq 0$ for all $z$,
