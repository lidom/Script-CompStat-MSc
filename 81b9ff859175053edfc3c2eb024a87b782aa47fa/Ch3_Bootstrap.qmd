...
$$
\gamma_{jj,n}:=\left[\left(\frac{1}{n}\sum_{i=1}^n X_iX_i^T\right)^{-1}\right]_{jj}.
$$
Then
$$
\sqrt{n}\frac{(\hat\beta_{n,j}-\beta_{0,j})}{\hat\sigma_n\sqrt{\gamma_{jj,n}}}
$$ 
with 
$$
...
$$
\sqrt{n}\frac{(\hat\beta_{n,j}-\beta_{0,j})}{\hat\sigma_n\sqrt{\gamma_{jj,n}}}\rightarrow_d\mathcal{N}(0,1),\quad n\to\infty.
$$
...
$$
\left[
  \hat\beta_{n,j}-\hat q^\ast_{1-\frac{\alpha}{2},n,j}\;\left(\frac{\hat\sigma_n \sqrt{\gamma_{jj,n}}}{\sqrt{n}}\right),\; 
  \hat\beta_{n,j}-\hat q^\ast_{\frac{\alpha}{2},n,j}\;\left(\frac{\hat\sigma_n \sqrt{\gamma_{jj,n}}}{\sqrt{n}}\right)
\right],
$$
where $\hat\beta_{n,j}$ and 
$\hat{\sigma}_n=\sqrt{\frac{1}{n}\sum_{i=1}^n\hat{\varepsilon}_i^2}$ are computed from the original sample $\mathcal{S}_n$ and where the empirical quantiles $\hat q^*_{n,1-\frac{\alpha}{2}}$ and $\hat q^*_{n,\frac{\alpha}{2}}$ are computed from the bootstrap estimates $T^*_{n,1},T_{n,2}^*,\dots, T_{n,m}^*.$
