...
Sampling (iid) from the empirical distribution function $F_n$ is equivalent to resampling (with replacement and with equal probabilities) data points from the observed data `observedSample`. 
