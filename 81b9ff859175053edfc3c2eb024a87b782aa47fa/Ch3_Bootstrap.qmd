...
&= \mathbb{E}\left({\color{blue}\mathbb{E}\left(1_{\left(X_i^*\leq x\right)}|\mathcal{S}_n\right)}\right)\quad[\text{{\color{blue}law of iterated expectations}}]\\[2ex]
...
$$
\begin{align*}
\mathbb{E}(\bar{X}_n|\mathcal{S}_n)&=\bar{X}_n\\[2ex]
Var(\bar{X}_n|\mathcal{S}_n) &=\frac{1}{n}\sum_{i=1}^n(X_i-\bar{X}_n)^2,
\end{align*}
$$ 
...
&\text{(Note: relevant $t$-values are values around zero):}]\\[2ex]
...
\Rightarrow\quad |\lambda_n(t)|& =O(n^{-3/2}) =o(n^{-1})\\[2ex]
\end{align*}
$$
...
\end{align*}
$$
the $o(n^{-1})$ term becomes negligible in comparison to the $O(n^{-1})$ term and the constant term such that  
<!-- 
$$
...
&\mathbb{E}(W^*_{n}|\mathcal{S}_n)=\mathbb{E}\left(\left.\frac{X_i^*-\bar{X}_n}{\sqrt{n}}\right|\mathcal{S}_n\right)=\frac{\mathbb{E}(X_i^*|\mathcal{S}_n)-\bar{X}_n}{\sqrt{n}}=0\quad\text{for all}\quad n,\quad\text{and}\\[2ex]
&Var(W^*_{n}|\mathcal{S}_n)=Var\left(\left.\frac{X_i^*-\bar{X}_n}{\sqrt{n}}\right|\mathcal{S}_n\right)=\frac{1}{n}Var(X_i^*-\bar{X}_n|\mathcal{S}_n)=\frac{1}{n}Var(X_i^*|\mathcal{S}_n)=\frac{1}{n}\hat\sigma_n^2.
\end{align*}
$$
...
\Leftrightarrow\quad {\color{red}|\lambda^*_n(t)|}&=o_{a.s.}(0).
\end{align*}
$$
...
\left[2\hat{\theta}_n-\hat q^*_{n,1-\frac{\alpha}{2}}, 2\hat{\theta}_n-\hat q^*_{n,\frac{\alpha}{2}}\right],
$$
is indeed an asymptotically valid $(1-\alpha)\times 100\%$ confidence interval.
