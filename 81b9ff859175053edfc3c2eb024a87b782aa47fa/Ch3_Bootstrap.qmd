...
where 
   ...
   * $\hat q^*_{n,1-\frac{\alpha}{2}}$ and $\hat q^*_{n,\frac{\alpha}{2}}$ are computed from the bootstrap estimates $\bar{X}_{n,1}^*,\dots,\bar{X}_{n,m}^*.$
...
$$
In this case $T_n$ is an **asymptotically pivotal statistic**.</br> 
...
$$
\frac{s_n}{\hat\sigma_n}\to_p 1\quad\text{as}\quad n\to\infty.
$$
