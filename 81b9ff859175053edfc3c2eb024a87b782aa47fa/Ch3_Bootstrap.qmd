...
* The  bootstrap will not work if the i.i.d. re-sample $X_1^*,\dots,X_n^*$ from $\mathcal{S}_n=\{X_1,\dots,X_n\}$ does not properly reflect the way how $X_1,\dots,X_n$ are generated in a first place. (For instance, when $X_1,\dots,X_n$ is generated by a time-series process with auto-correlated data, but the bootstrap samples are generated by i.i.d. sampling.) 
* The distribution of 
$$
\sqrt{n}\left(\hat\theta_n-\theta_0\right)
$$ 
