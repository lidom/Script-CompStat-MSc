...
Then
$$
\frac{\sqrt{n}(\hat\beta_{n,j}-\beta_{0,j})}{\hat\sigma_n\sqrt{\gamma_{jj,n}}}
$$ 
with 
$$
...
$$
\frac{\sqrt{n}(\hat\beta_{n,j}-\beta_{0,j})}{\hat\sigma_n\sqrt{\gamma_{jj,n}}}\rightarrow_d\mathcal{N}(0,1),\quad n\to\infty.
$$
