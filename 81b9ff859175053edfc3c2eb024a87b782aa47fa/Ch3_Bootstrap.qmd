...
The following two confidence intervals use the basic bootstrap method (@sec-BasicBootstrap) and the bootstrap-$t$ method (@sec-BootT). 
...
1. Generate $m$ (e.g. $m=10,000$) bootstrap realizations
$$
