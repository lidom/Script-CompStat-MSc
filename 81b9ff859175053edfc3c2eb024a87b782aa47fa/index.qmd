...
timetable <- tibble("Day"=c("Monday", "Thursday"),
                    "Time"=c("14:15-15:45", "14:15-15:45"),
...
* We'll use an [eWhiteboard](https://www.dropbox.com/scl/fi/064lbiq4zs0rt7l392szq/eWhiteboard_annotated.pdf?rlkey=89yys1yvzx5wqgut7m3b7tido&dl=0) for derivations and some extra explanations.  
...
* The exam will contain 10 multiple-choice (single-select) problems and 2 free-text problems. Both parts of the exam are graded separately and the final grade is then an equally weighted average of these grades. 
