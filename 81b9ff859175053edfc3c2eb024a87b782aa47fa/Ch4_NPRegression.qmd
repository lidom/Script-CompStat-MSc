...
::: {.callout-note}
# Over-fitting 
Note that in econometrics (where we assumed to know the model apart from the model parameters) we used @eq-ARSS as an estimator for $\sigma^2.$ Moreover, @eq-ARSS is the main component to compute the $R^2$ coefficient.  
