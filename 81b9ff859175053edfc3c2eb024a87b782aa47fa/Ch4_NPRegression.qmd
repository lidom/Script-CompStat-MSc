...
$$
\begin{align*}
s(x)&\in\mathcal{S}_{k=1,\tau_1,\dots,\tau_q}\quad(\text{with}\;\;q=5)\\[2ex]
s(x)&= \sum_{j=1}^{7}b_{j,1}
\end{align*}
$$ 
...
$$
\begin{align*}
s(x)&\in\mathcal{S}_{k=2,\tau_1,\dots,\tau_q}\quad(\text{with}\;\;q=5)\\[2ex]
s(x)&= \sum_{j=1}^{8}b_{j,1}
\end{align*}
$$ 
...
$$
\begin{align*}
s(x)&\in\mathcal{S}_{k=3,\tau_1,\dots,\tau_q}\quad(\text{with}\;\;q=5)\\[2ex]
s(x)&= \sum_{j=1}^{9}b_{j,1}
\end{align*}
$$ 
