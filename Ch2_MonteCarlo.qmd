...
Many integration problems, such @exm-ApproxNormTables, can be written as a proportion $0\leq p\leq 1.$ This allows us compute the integral using using empirical proportions 
$$
