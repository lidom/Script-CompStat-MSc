...
A possible way to construct normal distribution tables, i.e., table for the values of the distribution function $0\leq \Phi(x)\leq 1,$ is to use MC integration. 
...
As demonstrated in @exm-ApproxNormTables, the accuracy of the Monte Carlo integration method depends on the variance of the estimate that approximates the integral value. 
